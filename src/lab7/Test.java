...
public class Test {
    ...
    public static List<TextSegment> getTextSegments() {
        ...
        textSegments.add(new PlainTextSegment(" poarta numele de "));
        ...
        textSegments.add(new PlainTextSegment(" ofera mai multe detalii legate de acest mecanism.\n"));
        textSegments.add(new PlainTextSegment("Pattern-ul "));
        textSegments.add(new BoldTextSegment("Visitor"));
        textSegments.add(new PlainTextSegment(" este util cand se doreste prelucrarea unei "));
