...
public class Main {
    public static void main(final String[] args) {
        ...
        logger1.message("Se executa metoda ProcessOrder()", LogLevel.Debug);
        logger1.message("Comanda a fost procesata cu succes", LogLevel.Info);
        logger1.message("Datele despre adresa clientului lipsesc din baza de date a filialei", LogLevel.Warning);
        logger1.message("Detele despre adresa clientului lipsesc din baza de date a organizatie", LogLevel.Error);
        logger1.message("Nu se poate procesa comanda #Comanda1 datata pe 25.11.2018 pentru clientul #Clientul1",
                LogLevel.FunctionalError);
        logger1.message("Comanda procesata", LogLevel.FunctionalMessage);

        /*
         * The output must look like below:
         *
         * [Console] Se executa metoda ProcessOrder()
         * [Console] Comanda a fost procesata cu succes
